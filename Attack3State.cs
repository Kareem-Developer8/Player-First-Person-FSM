...
public class Attack3State : State
{
    ...
    public Attack3State(Sophia Sofia, StateMachine stateMachine, string animBoolName) : base(Sofia, stateMachine, animBoolName)
    {
    }
    ...
    public override void Exit()
    {
        ...
        rose.agent.isStopped = false; base.Exit();
    }
